...
<spring:url
	value="${pageContext.request.contextPath}/resources/js/datetimepicker_css.js"
	var="mainJs" />
	...
	<div id="main">
		...
		<div id="site_content">
			<div class="sidebar">
				...
				<font size="3"><br> <br> <br> <br>
					<Address>
						3rd Floor, RMZ Westend Centre 3<br> D.P. Road, Aundh<br>
						Pune 411007<br> Email id: abc@gmail.com<br> Phone no.:
						7387777727
					</Address></font>
				<p>
					<br /> <br />NOTE: For any queries <a
						href="mailto:webmaster@example.com">mail us</a>.<br>
				</p>
			</div>
			<div id="content">
				...
				<iframe frameborder="0" scrolling="no" marginheight="0"
					marginwidth="0" width="500" height="440"
					src="https://maps.google.com/maps?hl=en&q=Cdac Acts Aundh pune&ie=UTF8&t=roadmap&z=15&iwloc=B&output=embed"></iframe>
