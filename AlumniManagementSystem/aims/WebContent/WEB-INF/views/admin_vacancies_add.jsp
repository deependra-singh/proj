	...
	<div id="main">
		...
		<div id="site_content">
			...
			<div id="content">
				...
				<form:form action="admin_vacancies_add"
					modelAttribute="vacancyModel1" method="post">
					...
					<div class="form_settings">
						...
						<p>
							...
							<textarea class="contact textarea" required="required"
								pattern="[a-zA-Z0-9,. -]*" title="Only charcters input" rows="5"
