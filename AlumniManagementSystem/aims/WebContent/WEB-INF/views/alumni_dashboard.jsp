				...
				<div style="float: left; width: 290px;">
					...
					<div id="vacancy" style="height: 310px; overflow: scroll">
						<c1:forEach items="${allVacancies_detail}" var="vacancy">
							<p>
								<b>Posted Date :</b> ${vacancy.vacancyCreateDate}<br /> <b>
									Last Date To apply :</b> ${vacancy.vacancyExpiryDate}<br /> <b>
									Company :</b> ${vacancy.vacancyCompany}<br /> <b> Designation
									:</b> ${vacancy.vacancyDesignation} <br />
								<b> Position :</b> ${vacancy.vacancyPosition}<br /> <b>
									Required Experience :</b> ${vacancy.vacancyReqexp}<br /> <b>
									Required Requirements :</b> ${vacancy.vacancyRequirements}<br /> <b>
									Description :</b> ${vacancy.vacancyDescription} <br />
								<b> Location :</b> ${vacancy.vacancyLocation} <br />
								<b> Contact Details :</b> ${vacancy.vacancyContact}<br /> <b>
									Email :</b> ${vacancy.vacancyEmail}<br />
								<b>Phone :</b> ${vacancy.vacancyPhone}
							</p>
							<hr />
						</c1:forEach>
					</div>
